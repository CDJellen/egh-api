...
type ExploreApiCache interface {
	...
	ReadContributors(ctx context.Context, owner domain.Owner, repo domain.Repo) (item domain.RepoContributors, err error)
	...
	ReadContributions(ctx context.Context, login domain.Login) (item domain.Contributions, err error)
